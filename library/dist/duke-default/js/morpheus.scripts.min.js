...
$PBJQ(".Mrphs-toolTitleNav__link--directurl").on("click",function(a){a=$PBJQ(this).siblings(".Mrphs-toolTitleNav__link--help-popup")[0].search;a={hitType:"event",eventCategory:"toolTitleNav",eventAction:"showDirectLink",eventLabel:document.title+" : "+a.substring(6,a.length)};"function"===typeof ga&&ga("send",a)});
$PBJQ(".Mrphs-toolTitleNav__link--help-popup").on("click",function(a){a=$PBJQ(this)[0].search;a={hitType:"event",eventCategory:"toolTitleNav",eventAction:"goToHelp",eventLabel:document.title+" : "+a.substring(6,a.length)};"function"===typeof ga&&ga("send",a)});$PBJQ("#print-view").on("click",function(a){a=$PBJQ(this)[0].search;a={hitType:"event",eventCategory:"toolTitleNav",eventAction:"lessionsPrintView",eventLabel:document.title+" : "+a.substring(6,a.length)};"function"===typeof ga&&ga("send",a)});
$PBJQ("#print-all").on("click",function(a){a=$PBJQ(this)[0].search;a={hitType:"event",eventCategory:"toolTitleNav",eventAction:"lessionsPrintAll",eventLabel:document.title+" : "+a.substring(6,a.length)};"function"===typeof ga&&ga("send",a)});$PBJQ("#show-pages").on("click",function(a){a=$PBJQ(this)[0].search;a={hitType:"event",eventCategory:"toolTitleNav",eventAction:"lessionsIndexOfPages",eventLabel:document.title+" : "+a.substring(6,a.length)};"function"===typeof ga&&ga("send",a)});
$PBJQ(".Mrphs-sitesNav__dropdown").on("click",function(a){a=$PBJQ(this).siblings("a.link-container")[0].title;a={hitType:"event",eventCategory:"sitesNav",eventAction:"openToolDropdown",eventLabel:document.title+" : "+a};"function"===typeof ga&&ga("send",a)});$PBJQ(".Mrphs-hierarchy--toolName").on("click",function(a){a={hitType:"event",eventCategory:"hierarchy",eventAction:"refreshTool",eventLabel:document.title};"function"===typeof ga&&ga("send",a)});
$PBJQ(".view-all-sites-btn").on("click",function(a){a={hitType:"event",eventCategory:"topHeader",eventAction:"openAllSitesDropdown",eventLabel:document.title};"function"===typeof ga&&ga("send",a)});$PBJQ("#toolsNav-toggle-li").on("click",function(a){a="undefined";$PBJQ(this).hasClass("min")?a="collapseTools":$PBJQ(this).hasClass("max")&&(a="maximizeTools");a={hitType:"event",eventCategory:"toolMenu",eventAction:a,eventLabel:document.title};"function"===typeof ga&&ga("send",a)});
$PBJQ("#print-view").on("click",function(a){a={hitType:"event",eventCategory:"toolTitleNav",eventAction:"showLessonsPrintView",eventLabel:document.title};"function"===typeof ga&&ga("send",a)});$PBJQ("#show-pages").on("click",function(a){a={hitType:"event",eventCategory:"toolTitleNav",eventAction:"showLessonsPages",eventLabel:document.title};"function"===typeof ga&&ga("send",a)});
var dukeAddBodyClasses=function(){var a=[],b=(new URL(window.location.href)).hostname.replace(/\./g,"-");a.push("duke-"+b);b="duke-role-"+portal.user.siteRole.toLowerCase().replace(/\s/g,"");a.push(b);var c;(c=document.getElementsByTagName("body")[0].classList).add.apply(c,[].concat($jscomp.arrayFromIterable(a)))};dukeAddBodyClasses();
var dukeCollapseToolsAdjustedTop=0,dukeAdjustNodesForPASystem=function(a,b){document.querySelectorAll(a).forEach(function(a){return a.style.top=b+"px"})},dukeWatchForPasystemLoad=function(a){var b=document.getElementsByClassName("Mrphs-portalBody")[0];(new MutationObserver(function(b,d){b=$jscomp.makeIterator(b);for(var c=b.next();!c.done;c=b.next())c=c.value,"childList"==c.type&&"pasystem-banner-alerts"==c.target.childNodes[0].className&&(dukeCollapseToolsAdjustedTop=document.getElementsByClassName("pasystem-banner-alerts")[0].clientHeight,
dukeAdjustNodesForPASystem(a,dukeCollapseToolsAdjustedTop),dukeWatchForPasystemChange(a),d.disconnect())})).observe(b,{childList:!0})},dukeWatchForPasystemChange=function(a){var b=document.getElementsByClassName("pasystem-banner-alerts")[0],c=document.getElementsByClassName("pasystem-banner-alert-toggle")[0],d={childList:!0,attributes:!0,subtree:!0,attributeOldValue:!0},e=function(c,d){c=$jscomp.makeIterator(c);for(d=c.next();!d.done;d=c.next())d=d.value,"childList"==d.type&&(dukeCollapseToolsAdjustedTop=
b.clientHeight,dukeAdjustNodesForPASystem(a,dukeCollapseToolsAdjustedTop)),"attributes"==d.type&&d.target.className.includes("pasystem-banner-alert")&&(dukeCollapseToolsAdjustedTop=b.clientHeight,dukeAdjustNodesForPASystem(a,dukeCollapseToolsAdjustedTop))},f=new MutationObserver(e),e=new MutationObserver(e);f.observe(b,d);e.observe(c,d)},dukeWatchForPASystemOnScroll=function(a){window.addEventListener("scroll",function(b){0<window.scrollY?dukeAdjustNodesForPASystem(a,0):dukeAdjustNodesForPASystem(a,
dukeCollapseToolsAdjustedTop)})};dukeWatchForPasystemLoad("#toolsNav-toggle-li");dukeWatchForPASystemOnScroll("#toolsNav-toggle-li");
if("Sakai : Home : Overview"===document.title)var setMOTDHeights=window.setTimeout(function(){for(var a=document.getElementsByClassName("Mrphs-toolBody--sakai-motd")[0].getElementsByTagName("iframe")[0].contentWindow.document.getElementsByClassName("textPanel"),b=[].slice.call(a),c=Math.max.apply(Math,b.map(function(a){return a.clientHeight})),d=0;d<b.length;d++)a[d].style.height=c+"px"},1E3);
if("null"!==document.getElementById("Mrphs-footer--details__info")){var buildTimeHtml="\x3cdt\x3eSkin | CDN:\x3c/dt\x3e\x3cdd\x3eDUKEGITHUBSHA | "+portal.portalCDNQuery.substr(9)+"\x3c/dd\x3e";document.getElementById("serverTime").insertAdjacentHTML("afterend",buildTimeHtml)}var logoContainer=document.querySelector(".Mrphs-headerLogo--institution"),homeLinkContainer=document.querySelector(".Mrphs-sitesNav__menuitem--myworkspace .link-container");logoContainer.style.cursor="pointer";
logoContainer.addEventListener("click",function(a){a={hitType:"event",eventCategory:"topHeader",eventAction:"clickLogo",eventLabel:document.title};"function"===typeof ga&&ga("send",a);homeLinkContainer.click()});
...
x(a));d=c;I()}},D=function(a){if(c&&-1<c.indexOf(a)){for(var b=c.indexOf(a),e=!1,f=b-1;0<=f;f--){var l=d.indexOf(c[f]);if(0<=l&&l<b){d.splice(l+1,0,a);e=!0;break}}e||d.splice(b,0,a)}};$PBJQ(h).on("click",".site-favorite-btn",function(){var a=$PBJQ(this).attr("data-site-id"),b=$PBJQ(this).data("favorite-state");"myworkspace"!==b&&(b="favorite"===b?"nonfavorite":"favorite","favorite"==b&&D(a),t(this,b),w(),v(),A(function(){B()}))});$PBJQ(h).on("click",".favorites-select-all-none",function(){var a=$PBJQ(this).data("favorite-state"),
...
function toggleUserNav(a){a.preventDefault();$PBJQ(".Mrphs-userNav__subnav").toggleClass("is-hidden");$PBJQ(".Mrphs-userNav__subnav").hasClass("is-hidden")?($PBJQ(".user-dropdown-overlay").remove(),$PBJQ(document).off("keyup",userNavEscHandler),$PBJQ(".Mrphs-userNav__drop-btn").attr("aria-expanded","false")):(a=$PBJQ('\x3cdiv class\x3d"user-dropdown-overlay" /\x3e'),a.on("click",function(a){toggleUserNav(a)}),$PBJQ("body").prepend(a),$PBJQ(document).on("keyup.usernav",userNavEscHandler),$PBJQ(".Mrphs-userNav__drop-btn").attr("aria-expanded",
"true"))}$PBJQ("#loginLink1").click(function(a){""===$PBJQ(this).attr("data-warning")||confirm($PBJQ(this).attr("data-warning"))||a.preventDefault()});$PBJQ(".js-toggle-user-nav a#loginUser \x3e .Mrphs-userNav__drop-btn","#loginLinks").on("click",toggleUserNav);$PBJQ(".js-toggle-user-nav .Mrphs-userNav__drop-btn","#loginLinks").on("click",toggleUserNav);
