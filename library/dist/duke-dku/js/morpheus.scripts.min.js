...
var dukeAddBodyClasses=function(){var a=[],b=(new URL(window.location.href)).hostname.replace(/\./g,"-");a.push("duke-"+b);portal.user&&portal.user.siteRole&&(b="duke-role-"+portal.user.siteRole.toLowerCase().replace(/\s/g,""),a.push(b));var c;(c=document.getElementsByTagName("body")[0].classList).add.apply(c,[].concat($jscomp.arrayFromIterable(a)))};dukeAddBodyClasses();
...
if("null"!==document.getElementById("Mrphs-footer--details__info")&&portal.portalCDNQuery){var buildTimeHtml="\x3cdt\x3eSkin | CDN:\x3c/dt\x3e\x3cdd\x3eDUKEGITHUBSHA | "+portal.portalCDNQuery.substr(9)+"\x3c/dd\x3e";document.getElementById("serverTime").insertAdjacentHTML("afterend",buildTimeHtml)}
if(document.querySelector(".Mrphs-headerLogo--institution")){var logoContainer=document.querySelector(".Mrphs-headerLogo--institution"),homeLinkContainer=document.querySelector(".Mrphs-sitesNav__menuitem--myworkspace .link-container");logoContainer.style.cursor="pointer";logoContainer.addEventListener("click",function(a){a={hitType:"event",eventCategory:"topHeader",eventAction:"clickLogo",eventLabel:document.title};"function"===typeof ga&&ga("send",a);homeLinkContainer.click()})}
if(document.querySelector(".Mrphs-sakai-samigo #takeAssessmentForm .honor-container")){var samHonorPledgeLabel=document.querySelector(".Mrphs-sakai-samigo #takeAssessmentForm .honor-container");samHonorPledgeLabel.insertAdjacentHTML("beforebegin",'\n    \x3cdiv class\x3d"jumbotron" id\x3d"honor-pledge-agreement"\x3e\n        \x3ch4\x3eDuke Kunshan Community Standard\x3c/h4\x3e\n        \x3cp\x3eDuke Kunshan University (DKU) is a community comprised of individuals from diverse cultures and backgrounds. We are dedicated to scholarship, leadership, and service and to the principles of honesty, fairness, respect, and accountability. Members of this community commit to reflecting upon and upholding these principles in all academic and non-academic endeavors and to protecting and promoting a culture of integrity and trust.\x3c/p\x3e\n        \x3cp\x3eTo uphold the DKU Community Standard\x3c/p\x3e\n        \x3cul\x3e\n            \x3cli\x3eI will hold myself to the highest standards for honesty, integrity, fairness, and responsibility in my academic and non-academic endeavors\x3c/li\x3e\n            \x3cli\x3eI will respect other cultures and embrace all forms of diversity\x3c/li\x3e\n            \x3cli\x3eI will uphold the standards if they are compromised.\x3c/li\x3e\n        \x3c/ul\x3e\n    \x3c/div\x3e')}
