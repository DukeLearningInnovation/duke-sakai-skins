...
$PBJQ("#subSites").css({position:"absolute",display:"block",left:c.left+d.width()+6+"px",top:c.top+"px"});
...
l='<li class="Mrphs-sitesNav__submenuitem" ><a class="Mrphs-sitesNav__submenuitem-icon"'+k+'><span class="toolMenuIcon icon-{{icon}}"></span></a><a class="Mrphs-sitesNav__submenuitem-title"'+k+">{{item_title}}</a></li>"
}else{var k=' role="menuitem" href="{{tool_url}}" title="{{item_title}}"';
l='<li class="Mrphs-sitesNav__submenuitem{{is_current}}"><a class="Mrphs-sitesNav__submenuitem-icon"'+k+'><span class="toolMenuIcon icon-{{icon}}"></span></a><a class="Mrphs-sitesNav__submenuitem-title"'+k+">{{item_title}}</a></li>"
...
$PBJQ("ul.Mrphs-sitesNav__menu li span.Mrphs-sitesNav__dropdown").click(function(f,b){f.preventDefault();
var h=$PBJQ(f.target);
var a=h.closest(".Mrphs-sitesNav__menuitem");
...
}var e=$('<div class="sitenav-dropdown-overlay" />');
