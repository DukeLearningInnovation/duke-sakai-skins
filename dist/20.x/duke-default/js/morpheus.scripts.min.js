...
logoContainer.addEventListener("click",function(a){a={hitType:"event",eventCategory:"topHeader",eventAction:"clickLogo",eventLabel:document.title};"function"===typeof ga&&ga("send",a);homeLinkContainer.click()});console.log("duke.default.js");
