...
b),g=d.closest(".portal-bullhorn-bunch"),h=1===g.find(".portal-bullhorn-alert").length,e=1===a(".portal-bullhorn-alert").length;d.remove();e&&a("#portal-bullhorn-alerts").html(portal.wrapNoAlertsString(c));h&&g.remove();d=a(".portal-bullhorn-alert").length;portal.setBullhornCounter(d)})};portal.clearAllBullhornAlerts=function(b){a.ajax({url:"/direct/portal/clearAllBullhornAlerts",cache:!1}).done(function(){a("#portal-bullhorn-alerts").html(portal.wrapNoAlertsString(b));portal.setBullhornCounter(0)})};
...
a.fromUser+'/image/thumb)"\x3e\x3c/div\x3e\n          \x3cdiv class\x3d"portal-bullhorn-message"\x3e\n            \x3cdiv\x3e\n              \x3ca href\x3d"'+a.url+'" class\x3d"portal-bullhorn-connectionmanager-pending"\x3e'+d+"\x3c/a\x3e\n            \x3c/div\x3e\n        "+n+"\n      ":"\n        "+m+'\n          \x3cdiv class\x3d"portal-bullhorn-icon fa fa-stack"\x3e\x3ci class\x3d"fa fa-circle fa-stack-2x"\x3e\x3c/i\x3e\x3ci class\x3d"fa '+k+' fa-stack-1x fa-inverse"\x3e\x3c/i\x3e\x3c/div\x3e\n          \x3cdiv class\x3d"portal-bullhorn-message"\x3e\n            \x3cdiv\x3e\n              \x3ca href\x3d"'+
a.url+'" style\x3d"text-decoration: none;"\x3e\n                \x3cspan class\x3d"portal-bullhorn-display-name"\x3e'+a.fromDisplayName+"\x3c/span\x3e\n                "+d+"\n              \x3c/a\x3e\n            \x3c/div\x3e\n          "+n+"\n        ";markup=h+a});return markup+="\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e"};a(function(){portal.bullhorn.qtip({suppress:!1,position:{adjust:{scroll:!1},my:"top right",at:"bottom left",target:portal.socialBullhorn},show:{event:"click",delay:0,solo:portal.socialBullhorn},
...
if("null"!==document.getElementById("Mrphs-footer--details__info")){var buildTimeHtml="\x3cdt\x3eSkin Version:\x3c/dt\x3e\x3cdd\x3eDUKEGITHUBSHA\x3c/dd\x3e";document.getElementById("serverTime").insertAdjacentHTML("afterend",buildTimeHtml)};