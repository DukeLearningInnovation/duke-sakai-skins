...
logoContainer.addEventListener("click",function(a){a={hitType:"event",eventCategory:"topHeader",eventAction:"clickLogo",eventLabel:document.title};"function"===typeof ga&&ga("send",a);homeLinkContainer.click()});if("undefined"!==typeof portal.siteTitle){var dukeSiteTitle='\x3cspan class\x3d"Duke-headerlogo--siteTitle"\x3e'+portal.siteTitle+"\x3c/span\x3e";document.getElementById("mastLogin").insertAdjacentHTML("beforebegin",dukeSiteTitle)}
