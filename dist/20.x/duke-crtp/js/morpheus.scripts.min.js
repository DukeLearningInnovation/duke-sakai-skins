...
$PBJQ(".Mrphs-toolTitleNav__link--directurl").on("click",function(a){a=$PBJQ(this).siblings(".Mrphs-toolTitleNav__link--help-popup")[0].search;a={hitType:"event",eventCategory:"toolTitleNav",eventAction:"showDirectLink",eventLabel:document.title+" : "+a.substring(6,a.length)};ga("send",a)});
$PBJQ(".Mrphs-toolTitleNav__link--help-popup").on("click",function(a){a=$PBJQ(this)[0].search;a={hitType:"event",eventCategory:"toolTitleNav",eventAction:"goToHelp",eventLabel:document.title+" : "+a.substring(6,a.length)};ga("send",a)});$PBJQ("#print-view").on("click",function(a){a=$PBJQ(this)[0].search;a={hitType:"event",eventCategory:"toolTitleNav",eventAction:"lessionsPrintView",eventLabel:document.title+" : "+a.substring(6,a.length)};ga("send",a)});
$PBJQ("#print-all").on("click",function(a){a=$PBJQ(this)[0].search;a={hitType:"event",eventCategory:"toolTitleNav",eventAction:"lessionsPrintAll",eventLabel:document.title+" : "+a.substring(6,a.length)};ga("send",a)});$PBJQ("#show-pages").on("click",function(a){a=$PBJQ(this)[0].search;a={hitType:"event",eventCategory:"toolTitleNav",eventAction:"lessionsIndexOfPages",eventLabel:document.title+" : "+a.substring(6,a.length)};ga("send",a)});
$PBJQ(".Mrphs-sitesNav__dropdown").on("click",function(a){a=$PBJQ(this).siblings("a.link-container")[0].title;ga("send",{hitType:"event",eventCategory:"sitesNav",eventAction:"openToolDropdown",eventLabel:document.title+" : "+a})});$PBJQ(".Mrphs-hierarchy--toolName").on("click",function(a){ga("send",{hitType:"event",eventCategory:"hierarchy",eventAction:"refreshTool",eventLabel:document.title})});
$PBJQ(".view-all-sites-btn").on("click",function(a){ga("send",{hitType:"event",eventCategory:"topHeader",eventAction:"openAllSitesDropdown",eventLabel:document.title})});$PBJQ("#toolsNav-toggle-li").on("click",function(a){a="undefined";$PBJQ(this).hasClass("min")?a="collapseTools":$PBJQ(this).hasClass("max")&&(a="maximizeTools");ga("send",{hitType:"event",eventCategory:"toolMenu",eventAction:a,eventLabel:document.title})});
$PBJQ("#print-view").on("click",function(a){ga("send",{hitType:"event",eventCategory:"toolTitleNav",eventAction:"showLessonsPrintView",eventLabel:document.title})});$PBJQ("#show-pages").on("click",function(a){ga("send",{hitType:"event",eventCategory:"toolTitleNav",eventAction:"showLessonsPages",eventLabel:document.title})});
