...
if("null"!==document.getElementById("Mrphs-footer--details__info")){var buildTimeHtml="\x3cdt\x3eSkin Version:\x3c/dt\x3e\x3cdd\x3eDUKEGITHUBSHA\x3c/dd\x3e";document.getElementById("serverTime").insertAdjacentHTML("afterend",buildTimeHtml)}console.log("duke.extend.js");dukeWatchForPasystemLoad(".Mrphs-siteHierarchy .Mrphs-hierarchy--siteName");dukeWatchForPASystemOnScroll(".Mrphs-siteHierarchy .Mrphs-hierarchy--siteName");
if("undefined"!==typeof portal.siteTitle){var dukeSiteTitle='\x3cspan class\x3d"Duke-headerlogo--siteTitle"\x3e'+portal.siteTitle+"\x3c/span\x3e";document.getElementById("mastLogin").insertAdjacentHTML("beforebegin",dukeSiteTitle)}
