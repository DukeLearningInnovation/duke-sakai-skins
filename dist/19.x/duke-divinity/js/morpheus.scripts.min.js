...
;var h=e("#connection-manager-connectionsview"),g=e("#connection-manager-searchresultsview"),v=e("#connection-manager-searchresultsview-count"),m=e("#connection-manager-navbar-current > span > a"),P=e("#connection-manager-navbar-pending > span > a"),B=function(e){if(0===e)v.html(portal.i18n.tr("connection-manager","connection_manager_no_results"));else{var t={count:e,criteria:portal.connectionManager.searchCriteria},o=e>1?portal.i18n.tr("connection-manager","connection_manager_results_count",t):portal.i18n.tr("connection-manager","connection_manager_result_count",t);v.html(o)}},$=function(){x.hide(),_.show(),h.show(),g.hide(),
m.parent().addClass("current"),P.parent().removeClass("current")},Q=function(){_.hide(),x.show(),h.show(),g.hide(),P.parent().addClass("current"),m.parent().removeClass("current")},J=function(o,n){var s=a();e("#connection-manager-connection-"+o).remove(),1===k.children().length&&b.hide();var l=r[o];l.connected=!1,l.hideConnect=!0,l.outgoing=!0,i[o]=l;var d=t(l);0===s&&(M.show().html(""),T.hide()),M.append(d),E(),("connections"===c||"searchresults"==c&&0===w.children().length)&&Q(),e("#connection-manager-cancel-button-"+o).click(R)};m.click(function(e){$()}),P.click(function(e){Q()})
...
;var y=e("#connection-manager-current-connections"),_=e("#connection-manager-current-connections-wrapper"),C=e("#connection-manager-no-current-connections-wrapper"),M=e("#connection-manager-pending-connections"),x=e("#connection-manager-pending-connections-wrapper"),T=e("#connection-manager-no-pending-connections-wrapper"),N=e("#connection-manager-connectionsview-searchbox");N.clearSearch({callback:function(){b.hide()}});var S=e("#connection-manager-searchresultsview-searchbox");0==d&&(u=P.html(),d+=1);var D=function(o){e("#connection-manager-connection-"+o).remove(),0==l&&y.html("");var a=i[o];a.outgoing=!1,a.incoming=!1,a.connected=!0
;var r=t(a);y.append(r),l+=1,e("#connection-manager-remove-button-"+o).click(H),C.hide(),delete i[o],1===k.children().length&&b.hide(),n[o]=a,E(),$()},L=function(){var t=this.dataset.userId,o=this.dataset.displayName;e.ajax("/direct/profile/"+portal.user.id+"/confirmFriendRequest?friendId="+t,{cache:!1}).done(function(e){D(t)}).fail(function(e,t,n){console.log("ERROR: failed to confirm request from '"+o+"'. errorThrown: "+n)})},I=function(t){e(".connection-manager-connection-"+t).remove(),delete i[t],1===k.children().length&&b.hide(),E()},A=function(){var t=this.dataset.userId,o=this.dataset.displayName
;e.ajax("/direct/profile/"+portal.user.id+"/ignoreFriendRequest?friendId="+t,{cache:!1}).done(function(e){I(t)}).fail(function(e,t,n){console.log("ERROR: failed to ignore request from '"+o+"'. errorThrown: "+n)})},j=function(){var t=this.dataset.userId,o=this.dataset.displayName;e.ajax("/direct/profile/"+portal.user.id+"/requestFriend?friendId="+t,{cache:!1}).done(function(e){J(t)}).fail(function(e,t,n){console.log("ERROR: failed to request connection to '"+o+"'. errorThrown: "+n)})},F=function(t){e("#connection-manager-connection-"+t).remove(),0==(l-=1)&&C.show(),delete n[t]},H=function(){var t=this.dataset.userId,o=this.dataset.displayName
;confirm(portal.i18n.tr("connection-manager","connection_manager_remove_confirm",{displayName:o}))&&e.ajax("/direct/profile/"+portal.user.id+"/removeFriend?friendId="+t,{cache:!1}).done(function(e){F(t)}).fail(function(e,t,n){console.log("ERROR: failed to remove '"+o+"'. errorThrown: "+n)})},R=function(){var t=this.dataset.userId,o=this.dataset.displayName;e.ajax("/direct/profile/"+t+"/ignoreFriendRequest?friendId="+portal.user.id,{cache:!1}).done(function(o){e(".connection-manager-connection-"+t).remove(),delete i[t],E()}).fail(function(e,t,n){console.log("ERROR: failed to ignore request from '"+o+"'. errorThrown: "+n)})},E=function(){
var e=a();0===e?(P.html(u),M.html("").hide(),T.show()):P.html(u+" ("+e+")")},q=function(a,l){e("#connection-manager-profile-popup-container .qtip").remove();var d=l?w:k;if(a.length<4)return d.html(""),void(l?B(0):b.hide());portal.connectionManager.searchCriteria=a;var u=l?t:o;e.ajax("/direct/portal/connectionsearch.json?query="+a,{cache:!1}).done(function(o){if(d.html(""),0!==o.length){l||b.show();var a="";r={},(s=o).forEach(function(e){r[e.uuid]=e}),l?s.forEach(function(e,t){a+=u(e)}):s.slice(0,5).forEach(function(e,t){a+=u(e)}),l&&B(s.length),d.html(a),d.children().length>0&&d.show(),e(function(){
l?e(".connection-manager-connect-button").click(j):profile.attachPopups(e(".profile-popup-trigger"),{hide:!0,container:"connection-manager-profile-popup-container",callbacks:{connect:J,cancel:I,accept:D,ignore:I,remove:F}}),e("#connection-manager-connectionsview-searchresults-more").click(function(o){c="searchresults",k.html(""),b.hide(),h.hide(),g.show(),S.val(portal.connectionManager.searchCriteria),N.val(""),e(function(){B(s.length);var o="";s.forEach(function(e,a){e.facebookSet=e.socialNetworkingInfo.facebookUrl,e.twitterSet=e.socialNetworkingInfo.twitterUrl,e.moreResult=!0,n.hasOwnProperty(e.uuid)&&(e.connected=!0,e.hideConnect=!0),
i.hasOwnProperty(e.uuid)&&(e.connected=!1,e.hideConnect=!0,e.outgoing=i[e.uuid].outgoing,e.incoming=i[e.uuid].incoming),o+=t(e)}),w.html(o),e(function(){e(".connection-manager-accept-button").click(L),e(".connection-manager-ignore-button").click(A),e(".connection-manager-connect-button").click(j),e(".connection-manager-remove-button").click(H),e(".connection-manager-cancel-button").click(R)})})}),e("#connection-manager-backtoconnections-link").click(function(e){c="connections",g.hide(),h.show(),b.hide(),k.html(""),N.val("")})})}else l||b.hide()})};e.ajax("/direct/profile/"+portal.user.id+"/connections.json",{cache:!1}).done(function(o){n={},
l=o.length,searchUserIdFilter=[portal.user.id],y.html(""),0==o.length?C.show():C.hide(),o.forEach(function(e){e.facebookSet=e.socialNetworkingInfo.facebookUrl,e.twitterSet=e.socialNetworkingInfo.twitterUrl,e.current=!0,e.connected=!0,e.incoming=!1,e.hideConnect=!0,n[e.uuid]=e,y.append(t(e))}),e(function(){e(".connection-manager-remove-button").click(H)})}).fail(function(e,t,o){console.log("ERROR: failed to get current connections. errorThrown: "+o)});e.ajax("/direct/profile/"+portal.user.id+"/incomingConnectionRequests.json",{cache:!1}).done(function(o){i={},o.forEach(function(e){e.incoming=!0}),
e.ajax("/direct/profile/"+portal.user.id+"/outgoingConnectionRequests.json",{cache:!1}).done(function(n){var a;n.forEach(function(e){e.outgoing=!0,o.push(e)}),0==(a=o).length?(T.show(),M.hide()):(T.hide(),M.show().html("")),a.forEach(function(e){e.hideConnect=!0,e.pending=!0,M.append(t(e)),i[e.uuid]=e}),a.length>0?P.html(u+" ("+a.length+")"):P.html(u),e(function(){e(".connection-manager-accept-button").click(L),e(".connection-manager-ignore-button").click(A),e(".connection-manager-cancel-button").click(R)})}).fail(function(e,t,o){console.log("Failed to get outgoing requests. errorThrown: "+o)})}).fail(function(e,t,o){
...
$PBJQ(".favorites-help-text").hide(),t?$PBJQ(".favorites-help-text.autofavorite-enabled").show():$PBJQ(".favorites-help-text.autofavorite-disabled").show(),f(),p(),a=!0},g=function(e){var i;v&&(a=!1,$PBJQ(".site-favorite-btn",s).empty(),$PBJQ(".favorites-select-all-none",s).empty()),e||(e=0),v&&e<100?setTimeout(function(){g(e+1)},50):(i=h,$PBJQ.ajax({url:"/portal/favorites/list",method:"GET",dataType:"json",success:function(e){t=e.autoFavoritesEnabled,n=e.favoriteSiteIds.filter(function(e,t){return""!=e}),null==o&&(o=n),i(n)}}))},v=!1,m=[],P=function(e){for(var t;m.length>0;)t=m.shift();t?$PBJQ.ajax({url:"/portal/favorites/update",
method:"POST",dataType:"json",data:{userFavorites:JSON.stringify(t)},error:e,complete:P}):v=!1},B=function(e){if(a){e||(e=function(){});var i=$PBJQ(".site-favorite-btn",s).has(".site-favorite").map(function(){return $PBJQ(this).attr("data-site-id")}).toArray(),r={favoriteSiteIds:i=i.sort(function(e,t){return-1===n.indexOf(e)?1:-1===n.indexOf(t)?-1:n.indexOf(e)-n.indexOf(t)}),autoFavoritesEnabled:t};m.push(r),v||(v=!0,P(e)),n=i,function(){if(function(e,t){if(e.length!=t.length)return!1;for(var o=0;o<e.length;o++)if(e[o]!=t[o])return!1;return!0
...
;"myworkspace"!==o&&("favorite"==(e="favorite"===o?"nonfavorite":"favorite")&&$(t),u(this,e),f(),p(),B(function(){g()}))}),$PBJQ(s).on("click",".favorites-select-all-none",function(){var e,t=$PBJQ(this).data("favorite-state"),o=$PBJQ(this).closest(".fav-sites-term").find(".fav-sites-entry:not(.my-workspace) .site-favorite-btn");e="favorite"==t?"nonfavorite":"favorite",o.each(function(t,o){u($PBJQ(o),e)}),p(),f(),B(function(){g()})}),$PBJQ(r).on("click",".tab-btn",function(){$PBJQ(".tab-btn",r).removeClass("active").attr("aria-selected","false").attr("tabindex","-1"),
...
;0==i?$PBJQ("#organizeFavoritesList").prepend(t):i>0?$PBJQ("#organizeFavoritesList li:nth-child("+i+")").after(t):$PBJQ("#organizeFavoritesList").append(t),e="favorite"}else $PBJQ("#organizeFavoritesPurgatoryList").append(t),e="nonfavorite";u(this,e),u(c[$PBJQ(this).attr("data-site-id")].find(".site-favorite-btn"),e),f(),p(),B(function(){g()})}}),$PBJQ("#autoFavoritesEnabled").click(function(){$PBJQ(this).attr("aria-checked",function(e,t){return String(!("true"===t))}),$PBJQ(this).trigger("change")}),$PBJQ("#autoFavoritesEnabled").on("change",function(){return t="true"===$PBJQ(this).attr("aria-checked"),$PBJQ(".favorites-help-text").hide(),
...
let e=document.getElementsByClassName("Mrphs-toolBody--sakai-motd")[0].getElementsByTagName("iframe")[0].contentWindow.document.getElementsByClassName("textPanel"),t=[].slice.call(e),o=Math.max.apply(Math,t.map(function(e){return e.clientHeight}));for(let n=0;n<t.length;n++)e[n].style.height=`${o}px`,e[n].getElementsByTagName("a")[0].style.cssText="bottom: 16px"},1e3)}if(document.getElementsByClassName("Mrphs-sakai-lessonbuildertool")[0]){let e=document.getElementsByClassName("Mrphs-hierarchy-item Mrphs-hierarchy--toolName")[0].clientWidth;document.getElementById("subpage-breadcrumb-div").style.cssText=`margin-left: ${e}px`}
if(document.querySelector("#msgForum .topicBloc .title")){let e=49+document.getElementsByClassName("topicBloc topicBlocLone specialLink")[0].clientHeight;document.querySelector("#msgForum .itemNav").style.cssText=`top:${e}px`}if(document.getElementById("msgForum")){let e=document.querySelector(".Mrphs-sakai-forums #msgForum .specialLink div.specialLink");e.clientHeight<30?e.style.cssText=`margin:-98px 0 calc(98px - ${e.clientHeight}px)`:e.clientHeight<40?e.style.cssText=`margin:-106px 0 calc(106px - ${e.clientHeight}px)`:e.clientHeight>40&&(e.style.cssText=`margin-bottom:calc(114px - ${e.clientHeight}px)`)}}($PBJQ),$PBJQ,
console.log("duke-divinity/_customization.js loaded");
/* Compiled on 2019-09-06_17-57-19 */
