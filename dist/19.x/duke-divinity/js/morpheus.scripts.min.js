...
l?e(".connection-manager-connect-button").click(j):profile.attachPopups(e(".profile-popup-trigger"),{hide:!0,container:"connection-manager-profile-popup-container",callbacks:{connect:J,cancel:I,accept:D,ignore:I,remove:F}}),e("#connection-manager-connectionsview-searchresults-more").click(function(o){c="searchresults",k.html(""),b.hide(),h.hide(),v.show(),S.val(portal.connectionManager.searchCriteria),N.val(""),e(function(){B(s.length);var o="";s.forEach(function(e,a){e.facebookSet=e.socialNetworkingInfo.facebookUrl,e.twitterSet=e.socialNetworkingInfo.twitterUrl,e.moreResult=!0,n.hasOwnProperty(e.uuid)&&(e.connected=!0,e.hideConnect=!0),
