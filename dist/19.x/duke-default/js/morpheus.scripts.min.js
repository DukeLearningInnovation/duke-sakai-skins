...
m.parent().addClass("current"),P.parent().removeClass("current")},Q=function(){_.hide(),T.show(),h.show(),v.hide(),P.parent().addClass("current"),m.parent().removeClass("current")},J=function(o,n){var s=a();e("#connection-manager-connection-"+o).remove(),1===k.children().length&&b.hide();var l=r[o];l.connected=!1,l.hideConnect=!0,l.outgoing=!0,i[o]=l;var d=t(l);0===s&&(M.show().html(""),x.hide()),M.append(d),q(),("connections"===c||"searchresults"==c&&0===w.children().length)&&Q(),e("#connection-manager-cancel-button-"+o).click(H)};m.click(function(e){$()}),P.click(function(e){Q()})
...
;var r=t(a);y.append(r),l+=1,e("#connection-manager-remove-button-"+o).click(R),C.hide(),delete i[o],1===k.children().length&&b.hide(),n[o]=a,q(),$()},L=function(){var t=this.dataset.userId,o=this.dataset.displayName;e.ajax("/direct/profile/"+portal.user.id+"/confirmFriendRequest?friendId="+t,{cache:!1}).done(function(e){N(t)}).fail(function(e,t,n){console.log("ERROR: failed to confirm request from '"+o+"'. errorThrown: "+n)})},I=function(t){e(".connection-manager-connection-"+t).remove(),delete i[t],1===k.children().length&&b.hide(),q()},A=function(){var t=this.dataset.userId,o=this.dataset.displayName
...
;confirm(portal.i18n.tr("connection-manager","connection_manager_remove_confirm",{displayName:o}))&&e.ajax("/direct/profile/"+portal.user.id+"/removeFriend?friendId="+t,{cache:!1}).done(function(e){F(t)}).fail(function(e,t,n){console.log("ERROR: failed to remove '"+o+"'. errorThrown: "+n)})},H=function(){var t=this.dataset.userId,o=this.dataset.displayName;e.ajax("/direct/profile/"+t+"/ignoreFriendRequest?friendId="+portal.user.id,{cache:!1}).done(function(o){e(".connection-manager-connection-"+t).remove(),delete i[t],q()}).fail(function(e,t,n){console.log("ERROR: failed to ignore request from '"+o+"'. errorThrown: "+n)})},q=function(){
var e=a();0===e?(P.html(u),M.html("").hide(),x.show()):P.html(u+" ("+e+")")},E=function(a,l){e("#connection-manager-profile-popup-container .qtip").remove();var d=l?w:k;if(a.length<4)return d.html(""),void(l?B(0):b.hide());portal.connectionManager.searchCriteria=a;var u=l?t:o;e.ajax("/direct/portal/connectionsearch.json?query="+a,{cache:!1}).done(function(o){if(d.html(""),0!==o.length){l||b.show();var a="";r={},(s=o).forEach(function(e){r[e.uuid]=e}),l?s.forEach(function(e,t){a+=u(e)}):s.slice(0,5).forEach(function(e,t){a+=u(e)}),l&&B(s.length),d.html(a),d.children().length>0&&d.show(),e(function(){
l?e(".connection-manager-connect-button").click(j):profile.attachPopups(e(".profile-popup-trigger"),{hide:!0,container:"connection-manager-profile-popup-container",callbacks:{connect:J,cancel:I,accept:N,ignore:I,remove:F}}),e("#connection-manager-connectionsview-searchresults-more").click(function(o){c="searchresults",k.html(""),b.hide(),h.hide(),v.show(),D.val(portal.connectionManager.searchCriteria),S.val(""),e(function(){B(s.length);var o="";s.forEach(function(e,a){e.facebookSet=e.socialNetworkingInfo.facebookUrl,e.twitterSet=e.socialNetworkingInfo.twitterUrl,e.moreResult=!0,n.hasOwnProperty(e.uuid)&&(e.connected=!0,e.hideConnect=!0),
i.hasOwnProperty(e.uuid)&&(e.connected=!1,e.hideConnect=!0,e.outgoing=i[e.uuid].outgoing,e.incoming=i[e.uuid].incoming),o+=t(e)}),w.html(o),e(function(){e(".connection-manager-accept-button").click(L),e(".connection-manager-ignore-button").click(A),e(".connection-manager-connect-button").click(j),e(".connection-manager-remove-button").click(R),e(".connection-manager-cancel-button").click(H)})})}),e("#connection-manager-backtoconnections-link").click(function(e){c="connections",v.hide(),h.show(),b.hide(),k.html(""),S.val("")})})}else l||b.hide()})};e.ajax("/direct/profile/"+portal.user.id+"/connections.json",{cache:!1}).done(function(o){n={},
...
console.log("Failed to get incoming requests. errorThrown: "+o)}),S.keyup(function(e){E(this.value,!1)}),S.keydown(function(t){13==t.which&&this.value.length>=4&&e("#connection-manager-connectionsview-searchresults-more").click()}),D.keyup(function(e){E(this.value,!0)}),p&&"pending"===p.state&&Q()},e("#Mrphs-userNav__submenuitem--connections").click(portal.connectionManager.show)}}($PBJQ),$PBJQ(document).ready(function(){updateFooterTime=function(){
...
;var t=new URL(window.location.href).hostname.replace(/\./g,"-");e("body").addClass(t),e("body").addClass(portal.user.siteRole.toLowerCase());var o=0;n();var n=function(){var t=document.getElementsByClassName("Mrphs-portalBody")[0];new MutationObserver(function(t,n){for(var a of t)"childList"==a.type&&"pasystem-banner-alerts"==a.target.childNodes[0].className&&(o=document.getElementsByClassName("pasystem-banner-alerts")[0].clientHeight,e("#toolsNav-toggle-li").css({top:o}),i(),n.disconnect())}).observe(t,{childList:!0})},i=function(){
var t=document.getElementsByClassName("pasystem-banner-alerts")[0],n=document.getElementsByClassName("pasystem-banner-alert-toggle")[0],i={childList:!0,attributes:!0,subtree:!0,attributeOldValue:!0},a=function(n,i){for(var a of n)"childList"==a.type&&(o=t.clientHeight,e("#toolsNav-toggle-li").css({top:o})),"attributes"==a.type&&a.target.className.includes("pasystem-banner-alert")&&(o=t.clientHeight,e("#toolsNav-toggle-li").css({top:o}))},r=new MutationObserver(a),s=new MutationObserver(a);r.observe(t,i),s.observe(n,i)};e(window).scroll(function(){e(window).scrollTop()>0?e("#toolsNav-toggle-li").css({top:0}):e("#toolsNav-toggle-li").css({top:o
})})}($PBJQ);
/* Compiled on 2019-05-14_22-11-01 */
