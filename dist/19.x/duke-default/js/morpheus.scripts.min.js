...
if(document.getElementsByClassName("topicBloc topicBlocLone specialLink")[0]&&window.innerWidth>799){let e=49+document.getElementsByClassName("topicBloc topicBlocLone specialLink")[0].clientHeight;document.querySelector("#msgForum .itemNav").style.cssText=`top:${e}px`}if(document.getElementById("msgForum")&&window.innerWidth>799){let e=document.querySelector(".Mrphs-sakai-forums #msgForum .specialLink div.specialLink")
;void 0!==e&&(e.clientHeight<30?e.style.cssText=`margin:-98px 0 calc(98px - ${e.clientHeight}px)`:e.clientHeight<40?e.style.cssText=`margin:-106px 0 calc(106px - ${e.clientHeight}px)`:e.clientHeight>40&&(e.style.cssText=`margin-bottom:calc(114px - ${e.clientHeight}px)`))}}($PBJQ);
/* Compiled on 2019-09-10_16-21-27 */
