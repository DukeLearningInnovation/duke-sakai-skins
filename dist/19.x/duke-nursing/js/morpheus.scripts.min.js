...
;var h=e("#connection-manager-connectionsview"),g=e("#connection-manager-searchresultsview"),v=e("#connection-manager-searchresultsview-count"),m=e("#connection-manager-navbar-current > span > a"),P=e("#connection-manager-navbar-pending > span > a"),B=function(e){if(0===e)v.html(portal.i18n.tr("connection-manager","connection_manager_no_results"));else{var t={count:e,criteria:portal.connectionManager.searchCriteria},o=e>1?portal.i18n.tr("connection-manager","connection_manager_results_count",t):portal.i18n.tr("connection-manager","connection_manager_result_count",t);v.html(o)}},$=function(){T.hide(),_.show(),h.show(),g.hide(),
m.parent().addClass("current"),P.parent().removeClass("current")},Q=function(){_.hide(),T.show(),h.show(),g.hide(),P.parent().addClass("current"),m.parent().removeClass("current")},J=function(o,n){var s=a();e("#connection-manager-connection-"+o).remove(),1===k.children().length&&b.hide();var l=r[o];l.connected=!1,l.hideConnect=!0,l.outgoing=!0,i[o]=l;var d=t(l);0===s&&(M.show().html(""),x.hide()),M.append(d),E(),("connections"===c||"searchresults"==c&&0===w.children().length)&&Q(),e("#connection-manager-cancel-button-"+o).click(H)};m.click(function(e){$()}),P.click(function(e){Q()})
;var b=e("#connection-manager-connectionsview-searchresults-wrapper"),k=e("#connection-manager-connectionsview-searchresults"),w=e("#connection-manager-searchresultsview-results");f.click(function(e){if("connection-manager-connectionsview-searchbox"!==e.target.id){var t=b[0].getBoundingClientRect();S[0].getBoundingClientRect();(e.pageX<t.left||e.pageY<t.top||e.pageX>t.left+t.width||e.pageY>t.top+t.height)&&b.hide()}})
;var y=e("#connection-manager-current-connections"),_=e("#connection-manager-current-connections-wrapper"),C=e("#connection-manager-no-current-connections-wrapper"),M=e("#connection-manager-pending-connections"),T=e("#connection-manager-pending-connections-wrapper"),x=e("#connection-manager-no-pending-connections-wrapper"),S=e("#connection-manager-connectionsview-searchbox");S.clearSearch({callback:function(){b.hide()}});var D=e("#connection-manager-searchresultsview-searchbox");0==d&&(u=P.html(),d+=1);var N=function(o){e("#connection-manager-connection-"+o).remove(),0==l&&y.html("");var a=i[o];a.outgoing=!1,a.incoming=!1,a.connected=!0
;var r=t(a);y.append(r),l+=1,e("#connection-manager-remove-button-"+o).click(R),C.hide(),delete i[o],1===k.children().length&&b.hide(),n[o]=a,E(),$()},L=function(){var t=this.dataset.userId,o=this.dataset.displayName;e.ajax("/direct/profile/"+portal.user.id+"/confirmFriendRequest?friendId="+t,{cache:!1}).done(function(e){N(t)}).fail(function(e,t,n){console.log("ERROR: failed to confirm request from '"+o+"'. errorThrown: "+n)})},I=function(t){e(".connection-manager-connection-"+t).remove(),delete i[t],1===k.children().length&&b.hide(),E()},A=function(){var t=this.dataset.userId,o=this.dataset.displayName
...
l?e(".connection-manager-connect-button").click(j):profile.attachPopups(e(".profile-popup-trigger"),{hide:!0,container:"connection-manager-profile-popup-container",callbacks:{connect:J,cancel:I,accept:N,ignore:I,remove:F}}),e("#connection-manager-connectionsview-searchresults-more").click(function(o){c="searchresults",k.html(""),b.hide(),h.hide(),g.show(),D.val(portal.connectionManager.searchCriteria),S.val(""),e(function(){B(s.length);var o="";s.forEach(function(e,a){e.facebookSet=e.socialNetworkingInfo.facebookUrl,e.twitterSet=e.socialNetworkingInfo.twitterUrl,e.moreResult=!0,n.hasOwnProperty(e.uuid)&&(e.connected=!0,e.hideConnect=!0),
i.hasOwnProperty(e.uuid)&&(e.connected=!1,e.hideConnect=!0,e.outgoing=i[e.uuid].outgoing,e.incoming=i[e.uuid].incoming),o+=t(e)}),w.html(o),e(function(){e(".connection-manager-accept-button").click(L),e(".connection-manager-ignore-button").click(A),e(".connection-manager-connect-button").click(j),e(".connection-manager-remove-button").click(R),e(".connection-manager-cancel-button").click(H)})})}),e("#connection-manager-backtoconnections-link").click(function(e){c="connections",g.hide(),h.show(),b.hide(),k.html(""),S.val("")})})}else l||b.hide()})};e.ajax("/direct/profile/"+portal.user.id+"/connections.json",{cache:!1}).done(function(o){n={},
...
e.ajax("/direct/profile/"+portal.user.id+"/outgoingConnectionRequests.json",{cache:!1}).done(function(n){var a;n.forEach(function(e){e.outgoing=!0,o.push(e)}),0==(a=o).length?(x.show(),M.hide()):(x.hide(),M.show().html("")),a.forEach(function(e){e.hideConnect=!0,e.pending=!0,M.append(t(e)),i[e.uuid]=e}),a.length>0?P.html(u+" ("+a.length+")"):P.html(u),e(function(){e(".connection-manager-accept-button").click(L),e(".connection-manager-ignore-button").click(A),e(".connection-manager-cancel-button").click(H)})}).fail(function(e,t,o){console.log("Failed to get outgoing requests. errorThrown: "+o)})}).fail(function(e,t,o){
console.log("Failed to get incoming requests. errorThrown: "+o)}),S.keyup(function(e){q(this.value,!1)}),S.keydown(function(t){13==t.which&&this.value.length>=4&&e("#connection-manager-connectionsview-searchresults-more").click()}),D.keyup(function(e){q(this.value,!0)}),p&&"pending"===p.state&&Q()},e("#Mrphs-userNav__submenuitem--connections").click(portal.connectionManager.show)}}($PBJQ),$PBJQ(document).ready(function(){updateFooterTime=function(){
...
},r=new MutationObserver(a),s=new MutationObserver(a);r.observe(t,i),s.observe(o,i)};o=document.getElementsByClassName("Mrphs-portalBody")[0],new MutationObserver(function(t,o){for(var a of t)"childList"==a.type&&"pasystem-banner-alerts"==a.target.childNodes[0].className&&(n=document.getElementsByClassName("pasystem-banner-alerts")[0].clientHeight,e("#toolsNav-toggle-li").css({top:n}),i(),o.disconnect())}).observe(o,{childList:!0}),e(window).scroll(function(){e(window).scrollTop()>0?e("#toolsNav-toggle-li").css({top:0}):e("#toolsNav-toggle-li").css({top:n})});window.setTimeout(function(){
let e=document.getElementsByClassName("Mrphs-toolBody--sakai-motd")[0].getElementsByTagName("iframe")[0].contentWindow.document.getElementsByClassName("textPanel"),t=[].slice.call(e),o=Math.max.apply(Math,t.map(function(e){return e.clientHeight}));for(let n=0;n<t.length;n++)e[n].style.height=`${o}px`,e[n].getElementsByTagName("a")[0].style.cssText="bottom: 16px"},1e3)}($PBJQ),$PBJQ,console.log("duke-nursing/_customization.js loaded");
/* Compiled on 2019-08-21_09-06-38 */
