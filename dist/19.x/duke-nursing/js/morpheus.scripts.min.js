...
;var r=t(a);y.append(r),l+=1,e("#connection-manager-remove-button-"+o).click(R),C.hide(),delete i[o],1===k.children().length&&b.hide(),n[o]=a,E(),$()},L=function(){var t=this.dataset.userId,o=this.dataset.displayName;e.ajax("/direct/profile/"+portal.user.id+"/confirmFriendRequest?friendId="+t,{cache:!1}).done(function(e){D(t)}).fail(function(e,t,n){console.log("ERROR: failed to confirm request from '"+o+"'. errorThrown: "+n)})},I=function(t){e(".connection-manager-connection-"+t).remove(),delete i[t],1===k.children().length&&b.hide(),E()},A=function(){var t=this.dataset.userId,o=this.dataset.displayName
...
i.hasOwnProperty(e.uuid)&&(e.connected=!1,e.hideConnect=!0,e.outgoing=i[e.uuid].outgoing,e.incoming=i[e.uuid].incoming),o+=t(e)}),w.html(o),e(function(){e(".connection-manager-accept-button").click(L),e(".connection-manager-ignore-button").click(A),e(".connection-manager-connect-button").click(j),e(".connection-manager-remove-button").click(R),e(".connection-manager-cancel-button").click(H)})})}),e("#connection-manager-backtoconnections-link").click(function(e){c="connections",g.hide(),h.show(),b.hide(),k.html(""),N.val("")})})}else l||b.hide()})};e.ajax("/direct/profile/"+portal.user.id+"/connections.json",{cache:!1}).done(function(o){n={},
